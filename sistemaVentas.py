...
def registrarse1():
    ...
    marco_registro.place(relx = 0.5, rely = 0.5, anchor = tk.CENTER) 
    marco_iniciar_sesion.place_forget()

# Al dar click al botón acceder del iniciar sesión
def acceder():

    marco_registro.destroy()
    marco_iniciar_sesion.destroy()
    marco_principal_derecha.grid(row = 0, column = 0, sticky = "wns")
    marco_principal_izquierda.grid(row = 0, column = 1, sticky = "snew")
    marco_CRUD_productos.grid(row = 0)
    marco_CRUD_clientes.grid(row = 1)
    marco_CRUD_ventas.grid(row = 2)

# Al dar click al botón tengo cuenta del registrarse
def tengo_cuenta():

    marco_registro.place_forget()
    marco_iniciar_sesion.place(relx = 0.5, rely = 0.5, anchor = tk.CENTER)

# Al dar click en el boton de CRUD productos aparece o desaparecen lo demas botones
def activar_CRUD_productos():

    global botones_productos_visibles

    botones_productos_visibles = not botones_productos_visibles

    if botones_productos_visibles:
...
# Al dar click sobre el botón de crear producto
def crear_producto():
...
# Al dar click sobre el botón de buscar producto
def buscar_producto():
...
# Al dar click al botón editar producto
def editar_producto():
...
# Mostrar mensaje de falta llenar por un pequeño tiempo
...
# Al dar click en el boton de CRUD clientes aparece o desaparecen lo demas botones
...
# Al dar click sobre el botón de crear cliente
def crear_cliente():
...
# Al dar click sobre el botón de buscar cliente
def buscar_cliente():
...
# Al dar click al botón editar cliente
def editar_cliente():
...
# Agregar datos a la lista cliente
def agregar_datos2():
...
# Al dar click en el boton de CRUD ventas aparece o desaparecen lo demas botones
...
# Al dar click sobre el botón de hacer venta
def hacer_venta():
...
# Al dar click sobre el botón de buscar venta
def buscar_venta():
...
# Al dar click al botón editar venta
def editar_venta():
...
# Agregar datos a la lista venta
def agregar_datos3():
...
# Marco desaparecido para que se vea mas bonito
...
# Marco donde entrará todos los datos para el inicio de sesión
...
# Para que pueda expandirse o ubicarse lo de adentro
...
# Texto de confirmacion de contraseña
...
# Entrada de confirmacion de contraseña
...
# Entrada Ubicacion de la empresa
...
# Entrada Direccion de la empresa
